    ...
    >
      <div className="origin-document-dialog__shell">
        ...
        <div className="origin-document-dialog__content" tabIndex="0" aria-label={language === "tr" ? "Kaydırılabilir belge ve özellikler" : "Scrollable document and specifications"}>
          <div ref={previewViewport} className={`origin-document-dialog__preview origin-document-dialog__preview--${fit}`} tabIndex="0" aria-label={language === "tr" ? "Kaydırılabilir belge ön izlemesi" : "Scrollable document preview"}>
            <img
